...
export default class GridItem extends React.Component {
    render() {
        ...
        return (
            <React.Fragment>
                <div className={classNames('cell-12', 'cell-md-6', {'fwReview': classToAdd === 'fwReview'}, {'cell-lg-4': (columns === 'three') || (columns === 'four'), 'cell-xl-3': columns === 'four', 'my-1': gap_y === 'small', 'my-2': gap_y !== 'small', 'my-sm-3': gap_y === 'large'})}>
