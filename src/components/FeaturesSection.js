...
export default class FeaturesSection extends React.Component {
    render() {
        ...
        return (
            <section className={classNames('section', 'features', {'has-border': _.get(section, 'has_border', null), 'has-cover': _.get(section, 'background_image', null), 'bg-none': bg_color === 'none', 'bg-white': bg_color === 'white', 'bg-primary': bg_color === 'primary', 'bg-secondary': bg_color === 'secondary', 'secondary-accent' : bg_color === 'secondary-accent', 'tertiary-accent' : bg_color === 'tertiary-accent','pt-4': padding_top === 'small', 'pt-6': (padding_top === 'medium') || (padding_top === 'large'), 'pt-md-7': padding_top === 'large', 'pb-0': padding_bottom === 'zero' , 'pb-4': padding_bottom === 'small', 'pb-6': (padding_bottom === 'medium') || (padding_bottom === 'large'), 'pb-md-7': padding_bottom === 'large'}, {'secondary-accent': (bg_color === 'secondary-accent')}, {'tertiary-accent': (bg_color === 'tertiary-accent')})}>
            	...
            	<div className={classNames('container', 'container--medium', {'mb-5': (feature_padding_y === 'small') || (feature_padding_y === 'medium'), 'mb-4': feature_padding_y === 'large', 'text-center': align_x === 'center', 'text-right': align_x === 'right'}, {'services-heading' : classToAdd === 'services-heading'})}>
